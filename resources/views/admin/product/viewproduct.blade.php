...
#product-quantity-input{background-color: #eee;border: none; width:auto; text-align: center;}
            ...
            <div class="product-right">
             ...
             <div class="product-quantity">
              ...
              <div class="product-quantity">
                ...
                <div>
                  <input type="text" disabled="" id="product-quantity-input" placeholder="0" value="{{$productsbyId->qty}}">
                </div>
               ...
               <div class="product-quantity">
                ...
                <div>
                  <input type="text" disabled="" id="product-quantity-input" placeholder="0" value="{{ ($productsbyId->publicationStatus == 1)? 'Published' : 'Unpublished'  }}">
                </div>
